...
export function LandingPage() {
  return (
    <main className="mx-auto flex min-h-[calc(100vh-11rem)] w-full max-w-7xl flex-col px-4 py-0 sm:px-6 lg:px-8">
      <section className="flex flex-col items-center justify-center text-center w-full mt-16 flex-1">
        ...
        <p className="mt-6 mb-10 max-w-2xl mx-auto text-lg leading-8 text-slate-300">
