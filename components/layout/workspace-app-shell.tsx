...
export function WorkspaceAppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="relative flex h-screen w-full overflow-hidden bg-slate-950 text-white">
      ...
      <aside
        className={cn(
          'fixed inset-y-0 left-0 z-50 flex w-[min(16rem,85vw)] flex-col justify-between overflow-hidden border-r border-white/10 bg-[#0A0F1C]/70 backdrop-blur-lg transition-transform duration-300 ease-in-out md:relative md:z-auto md:h-full md:w-64 md:flex-shrink-0 md:translate-x-0',
